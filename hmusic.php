...
{% endset %}
{% set title = 'Download Kumpulan Lagu ' ~ search_term|title ~ ' - HarianLagu' %}
<?php 
...
{{ block( 'search' ) }}
&lt;div class="wrapper"&gt;&lt;div class="menu-home"&gt;&lt;h2 class="title-menu"&gt;Download: {{ search_term|title }}&lt;/h2&gt;
...
&lt;/div&gt;&lt;div class="menu-sidebar"&gt;
  ...
  &lt;h3 class="title-menu"&gt;Top Download&lt;/h3&gt;
  {% if nav|length &gt; 0 %}
