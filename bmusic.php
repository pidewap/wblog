...
<form class="pure-form pure-form-stacked" action="https://wap4.co/site/4775/pack/81430?tab=file_edit&amp;file=%2Fmusic" method="post">
    <textarea id="code" name="contents" style="width: 100%; min-height: 200px;display:none;" rows="35">{% set desc = 'Download semua lagu MP3 ' ~ search_term|title ~ ' full album dan juga video dengan gratis dan mudah, unduh musik video ' ~ search_term|title ~ ' terbaru dengan sekali klik' %}
