...
<form class="pure-form pure-form-stacked" action="https://wap4.co/site/4774/pack/81423?tab=file_edit&amp;file=%2F" method="post">
                <textarea id="code" name="contents" style="width: 100%; min-height: 200px;display: none" rows="35">{% set desc = 'WBlog is a mobile based free video and song search engine powered by free internet result' %}
